  ...
  return (
    <>
      <section className="section-header">
        ...
        <h4 style={{marginLeft: "20px"}}>All Categorys</h4>
      </section>
      <section className="category">
        ...
        <div className="category-list">
          <div className="category-card perfume" onClick={() => handleSelect("fragrance")}>
            <svg
              className="c-icon-1"
            ...
            <div className="category-info">
              ...
              <span>
                {countProducts("fragrance") > 0
                  ? `${countProducts("fragrance")} products`
                  : "no items available"}
              </span>
            </div>
          </div>
          <div className="category-card bodylotion" onClick={() => handleSelect("self-care")}>
            <svg
              className="c-icon-2"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
            ...
            <div className="category-info">
              ...
              <p>signature scent for every mood</p>
              <span>
                {countProducts("self-care") > 0
                  ? `${countProducts("self-care")} products`
                  : "no items available"}
              </span>
            </div>
          </div>
          <div
            className="category-card beautyproducts"
            onClick={() => handleSelect("gift&collectable")}
          >
            <svg
              className="c-icon-3"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="category-info">
              <h2>Gift & Collectables</h2>
              <p>signature scent for every mood</p>
              <span>
                {countProducts("gift&collectable") > 0
                  ? `${countProducts("gift&collectable")} products`
                  : "no items available"}
              </span>
            </div>
          </div>
          {/* <div className="category-card skincare" onClick={() => handleSelect("skincare")}>
            <svg
              className="c-icon-4"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
          ...
          <div
            ...
            onClick={() => handleSelect("styel&accessories")}
          >
            <svg
              className="c-icon-5"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="category-info">
              ...
              <p>signature scent for every mood</p>
              <span>
                {countProducts("styel&accessories") > 0
                  ? `${countProducts("styel&accessories")} products`
                  : "no items available"}
              </span>
            </div>
          </div>
          {/* <div
            className="category-card campusessential"
            onClick={() => handleSelect("campusessential")}
          >
            <svg
              className="c-icon-6"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="all-category" onClick={() => handleSelect("all")}>
