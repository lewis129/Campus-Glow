  ...
  return (
    <>
      <section className="why-us">
        <h2 className="why-us-h2">Why choose campus glow?</h2>
        <p className="why-us-p">
          we're not just another beauty sho. we're youre campus beauty partner,
          dedicated to helping <br /> you look and feeel your best without
          breaking the bank
        </p>
        <div className="why-us-container">
          <div className="why-us-card">
            ...
            <h3>100% Authentic</h3>
            <p>
              we only stock genuine, quality checked products from trusted
              brands.
            </p>
          </div>
          <div className="why-us-card">
            ...
            <h3>Fast Delivery</h3>
            <p>
              same-day delivered within campus. order in the morning glow up by
              evening!
            </p>
          </div>
          <div className="why-us-card">
            ...
            <p>
              affordable pricess and flexible payment option designed for
              students.
            </p>
          </div>
          <div className="why-us-card">
            ...
            <h3>Trusted by1000+</h3>
            <p>join thousands of satisfied students who trust Campus Glow.</p>
          </div>
        </div>
      </section>
    </>
